...
import { register, getUserInfo } from "@/services/auth.service";
...
export function SignUp() {
  ...
  const handleSignUp = async () => {
    try {
      setLoading(true);
      const resAccessToken = await register(newUser.first_name, newUser.last_name, newUser.username, newUser.email, newUser.password);
      if (resAccessToken.status === 200 || resAccessToken.status === 201) {
